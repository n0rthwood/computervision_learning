function [BW,maskedRGBImage] = rgbMask(RGB)
...
tMat = [0.002944 0.000138 0.000000 -0.518532;
    -0.000111 0.003642 0.000000 -0.480754;
    0.000000 0.000000 -0.003865 9.160254;
...
hPoints(1).data = [-0.483929 -0.538369;
    -0.531444 -0.602806;
    -0.640935 -0.738504;
    -0.814467 -0.787780;
    -0.820665 -0.887847;
