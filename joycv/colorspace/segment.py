...
from colorspace import color_threshold


def threshold_by_colorspace(image, color_cvt_code=(cv2.COLOR_RGB2HSV, cv2.COLOR_RGB2Lab, cv2.COLOR_RGB2YCrCb),
                            genre='general', category='general'):
    masks = []
