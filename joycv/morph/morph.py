...
def close_and_open_low_resolution(mask, close_kernel_size=(8,3), open_kernel_size=5):
    mmorphed_kernal = cv2.getStructuringElement(cv2.MORPH_RECT, close_kernel_size)
    mmorphed_mk = cv2.morphologyEx(mask, cv2.MORPH_CLOSE, mmorphed_kernal, iterations=2)
